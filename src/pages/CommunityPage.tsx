        ...
        <div className="space-y-6">
          ...
          {/* <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-sm text-gray-600">Click topic to view discussions</span>
            </div>
