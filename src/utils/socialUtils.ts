...
export const generateAnonymousUser = (): AnonymousUser => {
  const nicknames = [
    '温暖的向日葵', '勇敢的小树', '坚强的云朵', '平静的湖水', '乐观的星星',
    '智慧的月亮', '温柔的微风', '坚韧的竹子', '纯真的雪花', '希望的晨光',
    '安静的山谷', '活力的彩虹', '宁静的森林', '美好的花朵', '自由的鸟儿'
  ]
...
export const interactionTypes: InteractionType[] = [
  { id: 'empathy', label: '我也有同感', emoji: '🤝', description: '表示经历相似，建立共鸣' },
  { id: 'support', label: '给你一个拥抱', emoji: '🤗', description: '提供情感支持和安慰' },
  { id: 'helpful', label: '这很有帮助', emoji: '💡', description: '表示从分享中获得启发' },
  { id: 'grateful', label: '感谢分享', emoji: '🙏', description: '对真诚分享表示感谢' },
  { id: 'encourage', label: '一起加油', emoji: '💪', description: '相互鼓励和打气' }
]
